...
public:
	...
	bool swapRedAndBlueChannel(std::filesystem::path outputPath);
	bool onlyRedChannel(std::filesystem::path outputPath);
	bool onlyGreenChannel(std::filesystem::path outputPath);
	bool onlyBlueChannel(std::filesystem::path outputPath);
};
